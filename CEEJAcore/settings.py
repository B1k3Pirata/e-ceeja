"""
Django settings for CEEJAcore project.
...
SECRET_KEY = 'django-insecure-d+olz@pu(@$uio&c2_vf+v)37w@k^66u4de=&dlp@+ac3yb^dm'
...
WSGI_APPLICATION = 'CEEJAcore.wsgi.application'
